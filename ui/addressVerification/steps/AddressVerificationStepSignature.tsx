...
const AddressVerificationStepSignature = ({ address, signingMessage, contractCreator, contractOwner, onContinue, noWeb3Provider }: Props) => {
  ...
  const contactUsLink = <span>contact us <Link href="mailto:info@Mikawa Inu.com">info@Mikawa Inu.com</Link></span>;
  ...
  return (
    <form noValidate onSubmit={ onSubmit }>
      ...
      <Box mb={ 8 }>
        <span>Please select the address to sign and copy the message and sign it using the Mikawa Inu message provider of your choice. </span>
