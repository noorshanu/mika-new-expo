...
const UI = Object.freeze({
  ...
  homepage: {
    ...
    plate: {
      background: getEnvValue(process.env.NEXT_PUBLIC_HOMEPAGE_PLATE_BACKGROUND) || 'linear-gradient(154deg,#07001e 16.42%,#07001e 217.47%)!important',
      textColor: getEnvValue(process.env.NEXT_PUBLIC_HOMEPAGE_PLATE_TEXT_COLOR) || '#fff',
    },
